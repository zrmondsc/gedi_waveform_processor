...
from build_cae_06_2x8 import build_CAE_06_2x8
...
autoencoder, encoder, decoder = build_CAE_06_2x8(input_shape)
...
autoencoder.save(os.path.join(model_dir, "cae_06_2x8_autoencoder.keras"))
encoder.save(os.path.join(model_dir, "cae_06_2x8_encoder.keras"))
decoder.save(os.path.join(model_dir, "cae_06_2x8_decoder.keras"))